  ...
  return (
    <div className="mx-4 md:mx-10 my-12 px-4 py-16 rounded-xl relative bg-gradient-to-r bg-color2">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <p className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-center items-center text-color1 font-extrabold w-full h-full object-cover opacity-5 text-9xl sm:text-[12rem] md:text-[16rem] min-w-max -rotate-12" style={{fontFamily: `${fontConfig?.specificFont.name}`}}>Radio Archive</p>
      </div>

      <div className="relative max-w-3xl mx-auto px-8 z-10 text-center text-white">
        <h3 className="text-2xl md:text-3xl font-extrabold leading-tight mb-6 text-color1"  style={{fontFamily: `${fontConfig?.specificFont.name}`}}>Our collectors and transcribers can be licensed to run on-premises at your own site on your own hardware.</h3>
